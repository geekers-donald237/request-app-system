...
class UserSeeder extends Seeder
{
    ...
    {
        User::factory()->create(['name' => 'Nyadjou Danielle', 'email' => 'danymckeny@gmail.com', 'password' => '123456789'])->rules()->attach(Rule::whereName(RuleEnum::STUDENT->value)->first()->id);
